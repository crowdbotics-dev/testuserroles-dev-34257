...
## Project Structure
    ...
    ├── testuserroles_dev_34257  # Django project configurations
...
1. Clone this repo and `cd testuserroles_dev_34257`
...
2. Clone this repo and `cd testuserroles_dev_34257`
